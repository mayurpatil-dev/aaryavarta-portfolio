...
function MainComponent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-purple-600/20 selection:text-amber-900">
      {/* Success Popup */}
      {showSuccessPopup && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[100] animate-fade-in backdrop-blur-sm">
          <div className="bg-white shadow-sm border border-slate-200 rounded-2xl p-8 max-w-md mx-4 text-center animate-scale-in shadow-[0_15px_40px_rgba(0,0,0,0.12)]">
            ...
            <button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white text-slate-900 font-bold px-6 py-3 rounded-lg transition-all duration-300 w-full"
            >
              Dismiss
            </button>
          </div>
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-slate-50/80 shadow-sm px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-1 z-50 backdrop-blur-md border-b border-slate-200 min-h-[48px] sm:min-h-[56px] lg:min-h-[64px]">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-full">
          ...
          <div className="hidden lg:flex space-x-6 xl:space-x-8 font-sans font-medium text-sm tracking-wide font-medium">
            <button
              ...
              className="text-slate-500 hover:text-purple-600 transition-all duration-300 relative group py-2"
            >
              HOME
          ...
          <div className="mt-2 pb-4 px-2">
            <div className="flex flex-col space-y-2 pt-2 font-sans font-medium text-sm tracking-wide">
              <button
                ...
                className="text-slate-500 hover:text-purple-600 transition-all duration-300 text-left py-2 px-3 hover:bg-slate-50 rounded"
              >
                HOME
              </button>
              <button
      ...
      <section
        id="services-section"
        className="px-4 py-16 sm:px-8 sm:py-24 lg:px-12 bg-white shadow-sm border-y border-slate-200 relative"
      >
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold font-sans text-slate-900">
              What We Can Do <span className="text-purple-600">For You</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Growing businesses outgrowing Excel sheets and needing custom automated pipelines.</span>
                </div>
              </div>
              <div>

                <ul className="space-y-2 text-slate-600 text-sm font-sans font-medium">
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Small to mid-sized businesses wanting quick, affordable, and field-tested dashboards.</span>
                </div>
              </div>
              <div>
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Logistics operators, warehouse owners, and farmers needing remote eyes on assets.</span>
                </div>
              </div>
              <div>
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Operations and IT managers spending hours copy-pasting data between services.</span>
                </div>
              </div>
              <div>
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Hardware developers, IoT product builders, and prototyping startups.</span>
                </div>
              </div>
              <div>
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:bg-white shadow-sm hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group flex flex-col justify-between">
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-6">
                  <span className="block font-sans font-medium text-[10px] uppercase text-purple-700 font-bold tracking-wider mb-1">Target Client</span>
                  <span className="text-slate-700 text-xs font-semibold">Factory owners and plant operations managers seeking to modernize and reduce downtime.</span>
                </div>
              </div>
              <div>
      ...
      <section
        id="work-section"
        className="px-4 py-16 sm:px-8 sm:py-24 lg:px-12 bg-slate-50 relative"
      >
        <div className="w-full max-w-7xl mx-auto">
          {/* Header */}
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold font-sans text-slate-900">
              Selected <span className="text-purple-600">Work</span>
            </h2>
            <p className="text-slate-500 mt-4 max-w-2xl mx-auto text-base sm:text-lg">
      ...
      <section
        id="about-section"
        className="px-4 py-16 sm:px-8 sm:py-24 lg:px-12 bg-slate-50 border-t border-slate-200"
      >
        <div className="w-full max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold font-sans text-slate-900">
              About <span className="text-purple-600">Aaryavarta</span>
            </h2>
            <p className="text-slate-600 mt-5 max-w-3xl mx-auto text-base sm:text-lg">
          ...
          <div className="max-w-3xl mx-auto bg-white shadow-sm border border-slate-200 rounded-xl p-6 sm:p-8 mb-16 text-center font-sans relative overflow-hidden shadow-sm">
            ...
            <p className="text-base sm:text-lg text-slate-700 italic mb-4 leading-relaxed">
              "Dream is not that which you see while sleeping, it is something that does not let you sleep."
            </p>
            <span className="font-sans font-medium text-xs text-purple-600 tracking-wider font-bold">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Mayur Patil */}
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group text-center flex flex-col justify-between">
              <div>
                <div className="mb-5 relative inline-block">
                  <img
                    src="/passphoto-new.png"
                    alt="Mayur Patil"
                    className="w-20 h-20 rounded-full object-cover border-2 border-slate-200 group-hover:border-purple-600 transition-all duration-300 mx-auto"
                  />
                  <span className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-emerald-500 border-2 border-white rounded-full"></span>
                </div>
                <h3 className="text-lg font-bold font-sans text-slate-900 group-hover:text-purple-600 transition-colors duration-300">
                  Mayur Patil
                </h3>
              ...
              <div>
                <div className="mb-5 border-t border-slate-100 pt-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 justify-center font-sans font-medium text-[9px]">
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">IoT Networks</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">Firmware Dev</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">PCB Layout</span>
                  </div>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-sans font-medium text-xs font-bold text-purple-600 hover:text-purple-700 inline-flex items-center gap-1 group/btn"
                >
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group text-center flex flex-col justify-between">
              ...
              <div>
                <div className="mb-5 border-t border-slate-100 pt-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 justify-center font-sans font-medium text-[9px]">
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">Hardware Design</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">Integration</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">Networking</span>
                  </div>
                </div>
                <a
            ...
            <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 hover:border-purple-600 hover:shadow-[0_10px_35px_rgba(0,0,0,0.03)] transition-all duration-300 group text-center flex flex-col justify-between">
              ...
              <div>
                <div className="mb-5 border-t border-slate-100 pt-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 justify-center font-sans font-medium text-[9px]">
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">Technical Writing</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">System Blueprints</span>
                    <span className="bg-slate-50 border border-slate-200 text-slate-500 px-2 py-0.5 rounded">QA Auditing</span>
                  </div>
                </div>
                <a
                  href="/portfolio/yash"
      ...
      <section
        id="contact-section"
        className="px-4 py-16 sm:px-8 sm:py-24 lg:px-12 bg-white shadow-sm border-t border-slate-200"
      >
            ...
            <form onSubmit={handleContactSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white shadow-sm border border-slate-200 focus:border-amber-500 rounded-lg px-4 py-3 text-slate-700 outline-none transition-all duration-300 text-sm focus:shadow-[0_2px_10px_rgba(245,158,11,0.05)]"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-white shadow-sm border border-slate-200 focus:border-amber-500 rounded-lg px-4 py-3 text-slate-700 outline-none transition-all duration-300 text-sm cursor-pointer focus:shadow-[0_2px_10px_rgba(245,158,11,0.05)]"
                >
              ...
              <div className="flex flex-col items-center gap-3">
                <button
                  ...
                  className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white disabled:bg-neutral-200 disabled:text-zinc-400 text-slate-900 font-bold py-3 px-8 rounded-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_4px_15px_rgba(147,51,234,0.2)] flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
                ...
                <span className="text-xs font-sans font-medium text-slate-500 block text-center">Response typically sent within 24–48 hours.</span>
              </div>
            </form>
          </div>
        </div>
        ...
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center md:text-left">
              <div className="text-xl font-bold text-slate-900 mb-4 font-sans font-medium">
                AARYAVARTA
              </div>
              ...
              <div className="flex space-x-3.5 justify-center md:justify-start">
                <a
                  href="#"
                  className="text-slate-500 hover:text-amber-500 transition-all duration-300"
                >
            ...
            <div className="text-center md:text-left">
              <h3 className="font-sans font-medium text-xs text-amber-500 uppercase tracking-widest mb-4">LINKS</h3>
            ...
            <div className="text-center md:text-left">
              <h3 className="font-sans font-medium text-xs text-amber-500 uppercase tracking-widest mb-4">SOLUTIONS</h3>
          ...
          <div className="border-t border-zinc-900 mt-10 pt-8 text-center text-slate-500 text-xs font-sans font-medium">
