...
function MainComponent() {
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="min-h-[80vh] sm:min-h-[70vh] flex flex-col justify-center px-4 sm:px-8 py-10 sm:py-16 lg:px-12 lg:py-24 pt-24 sm:pt-32 text-center relative overflow-hidden">
